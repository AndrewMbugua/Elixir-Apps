defmodule ProjectManagementExample.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      ProjectManagementExampleWeb.Telemetry,
      # Start the PubSub system
      {Phoenix.PubSub, name: ProjectManagementExample.PubSub},
      # Start the Endpoint (http/https)
      ProjectManagementExampleWeb.Endpoint
      # Start a worker by calling: ProjectManagementExample.Worker.start_link(arg)
